...
public class Carriers {
	...
	public void setReceivecompany(String receivecompany) {
		this.receivecompany = receivecompany == null ? null : receivecompany
				.trim();
	}
	...
	public void setFkReceiveaddress(String fkReceiveaddress) {
		this.fkReceiveaddress = fkReceiveaddress == null ? null
				: fkReceiveaddress.trim();
	}
	...
	public void setReceivelinkman(String receivelinkman) {
		this.receivelinkman = receivelinkman == null ? null : receivelinkman
				.trim();
	}
