	...
	<div class="layout-admin">
		...
		<section class="layout-main">
			...
			<div class="layout-main-body">
				<iframe class="body-iframe" name="iframe0" width="100%" height="99%" src="../sadmin/relay.action?path=list" frameborder="0" data-id="home.html" seamless></iframe>
			</div>
		</section>
	</div>
	<script type="text/javascript" src="../../../../LMS/common/lib/jquery-1.9.0.min.js"></script>
	<script type="text/javascript" src="../../../../LMS/common/js/asccl.js"></script>
