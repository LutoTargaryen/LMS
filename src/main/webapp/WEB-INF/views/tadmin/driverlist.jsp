	...
	<script type="text/javascript">
		$(function(){
			$("#allusers").datagrid({
				...
				cls:"easyui-datagrid",
				title:"所有用户",
				url:"driverlist.action",
				columns:[[    
				          {field:'name',title:'驾驶员姓名',width:150,align:'center'},    
				          {field:'sex',title:'驾驶员性别',width:150,align:'center',
				          ...
				          {field:'phone',title:'驾驶员电话',width:150,align:'center'},
				          {field:'fkTeamid',title:'车牌号码',width:150,align:'center'},
				          
				          {field:"driverid",title:'操作', width:150,align:'center',
					  		  	formatter: function(value,row,index){
